...
if user_method == "1":
    user_x0 = float(input("Please type a number for x0: "))
    user_x1 = value_x1(user_x0, function)  # Get x1 based on x0
    roots, iterations = secant_method(user_x0, user_x1, tolerance, user_flag, function)
    print("Roots: ", roots, " Iterations: ", iterations)

if user_method == "2":
    user_x0 = float(input("Please type a number for x0: "))
    user_x1 = FP_value_x1(user_x0, function)  # Get x1 for the False Position Method
    roots, iterations = falsePosition_method(user_x0, user_x1, tolerance, user_flag, function)
    print("Roots: ", roots, " Iterations: ", iterations)
