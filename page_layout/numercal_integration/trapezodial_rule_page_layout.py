...
from functions.Ant.numerical_integration.trapezoidal_rule import trapezoidal_rule
        ...
        if st.button("Input Values"):
            ...
            st.markdown(
                f"""
                        ...
                        <h4>
                            The integrated value is: <span class="focus_highlight">{trapezoidal_rule(x_arr,y_arr,inh)}</span>
                        </h4>
